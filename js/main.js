...
bPlayerLoaded = false, bSettingsLoaded = false, bPlaylistFileLoaded = false, bDownloadRunning = false, sUserAgent = 'Mozilla/5.0 (IPTV ' + sAppVersion + ') ' + sDeviceFamily,
...
function downloadPlaylistAjax( sUrl, sCallback ) {
	...
	if( sUrl === "https://jeromelaliag.link/demo-pl.php" && typeof(sDemoPlaylist) !== 'undefined' ) {
...
function loadLatestVersion() {
	...
	switch( sDeviceFamily ) {
		case 'LG':
			location.href = 'http://jeromelaliag.link/lg/'; break;
		case 'Samsung':
			location.href = 'http://jeromelaliag.link/samsung/'; break;
		case 'Apple':
			location.href = 'http://jeromelaliag.link/apple/'; break;
		case 'Android':
			location.href = 'http://jeromelaliag.link/android/'; break;
		default:
			location.href = 'http://jeromelaliag.link/browser/'; break;
	}
...
function setUserAgentSetting( sNewUserAgent ) {
	...
	if( sNewUserAgent ) {
		...
		sUserAgent = 'Mozilla/5.0 (jeromelaliag.link ' + sAppVersion + ') ' + sDeviceFamily;
	}
